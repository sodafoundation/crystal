...
import (
	...
	"github.com/opensds/crystal/api/pkg/aksk"
	"github.com/opensds/crystal/api/pkg/backend"
	"github.com/opensds/crystal/api/pkg/filters/auth"
	"github.com/opensds/crystal/api/pkg/filters/context"
	"github.com/opensds/crystal/api/pkg/filters/logging"
	"github.com/opensds/crystal/api/pkg/filters/signature/signer"
	"github.com/opensds/crystal/api/pkg/metadata"
	"github.com/opensds/crystal/api/pkg/s3"
	"github.com/opensds/crystal/api/pkg/utils/obs"
...
func main() {
	...
	if flag == "s3" {
		...
		s3ws.Path("/")
		s3ws.Doc("OpenSDS crystal S3 API")
