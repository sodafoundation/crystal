...
// A Value is the OpenSDS crystal credentials value.
type Value struct {
	// OpenSDS crystal Access key ID
	AccessKeyID string

	// OpenSDS crystal Secret Access Key
...
// A Credentials provides concurrency safe retrieval of OpenSDS crystal credentials Value.
