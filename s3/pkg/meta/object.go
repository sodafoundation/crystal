...
import (
	...
	tidbclient "github.com/opensds/crsytal/s3/pkg/meta/db/drivers/tidb"
	"github.com/opensds/crsytal/s3/pkg/meta/redis"
...
func (m *Meta) PutObject(ctx context.Context, object, deleteObj *Object, multipart *Multipart, objMap *ObjMap, updateUsage bool) error {
	...
	// see https://github.com/opensds/crsytal/issues/698 for redis related issue.
